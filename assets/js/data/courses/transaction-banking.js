    ...
    },
    {
      ...
      "lessons": [
        ...
        },
        {
          ...
          "body": "<p>There is no global payment system. A bank in Kenya cannot settle US dollars directly, because dollar settlement happens across accounts at the Federal Reserve and it has none. So it holds an account with a bank that does.</p>\n<h4>Nostro and vostro</h4>\n<p>The same account, named from either side:</p>\n<ul>\n<li><strong>Nostro</strong> — \"our account with you.\" The Kenyan bank's dollar account held at a US bank.</li>\n<li><strong>Vostro</strong> — \"your account with us.\" The identical account, described by the US bank.</li>\n</ul>\n<p>A cross-border payment is a series of debits and credits along a chain of such accounts until the money reaches a bank that can pay the beneficiary locally.</p>\n<figure class=\"figure\"><svg viewBox=\"0 0 720 250\" role=\"img\" aria-label=\"A cross-border payment passing along a chain of correspondent accounts\"><defs><marker id=\"ah\" viewBox=\"0 0 10 10\" refX=\"9\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\"><path d=\"M0,0 L10,5 L0,10 z\" fill=\"var(--ink3)\"/></marker></defs><rect x=\"20\" y=\"60\" width=\"150\" height=\"64\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"95.0\" y=\"88.0\" text-anchor=\"middle\" font-size=\"13\" class=\"t-strong\">Payer&#8217;s bank</text><text x=\"95.0\" y=\"105.0\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">Nairobi</text><rect x=\"240\" y=\"60\" width=\"180\" height=\"64\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"330.0\" y=\"88.0\" text-anchor=\"middle\" font-size=\"13\" class=\"t-strong\">Correspondent bank</text><text x=\"330.0\" y=\"105.0\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">New York</text><rect x=\"490\" y=\"60\" width=\"150\" height=\"64\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"565.0\" y=\"88.0\" text-anchor=\"middle\" font-size=\"13\" class=\"t-strong\">Beneficiary&#8217;s bank</text><text x=\"565.0\" y=\"105.0\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">Lagos</text><line x1=\"176\" y1=\"92\" x2=\"234\" y2=\"92\" stroke=\"var(--ink3)\" stroke-width=\"2\" marker-end=\"url(#ah)\"/><line x1=\"426\" y1=\"92\" x2=\"484\" y2=\"92\" stroke=\"var(--ink3)\" stroke-width=\"2\" marker-end=\"url(#ah)\"/><rect x=\"176\" y=\"140\" width=\"250\" height=\"52\" rx=\"8\" fill=\"none\" stroke=\"var(--brand)\" stroke-width=\"1.5\" stroke-dasharray=\"4 3\"/><text x=\"301\" y=\"160\" text-anchor=\"middle\" font-size=\"11.5\" class=\"t-strong\">One account, two names</text><text x=\"301\" y=\"177\" text-anchor=\"middle\" font-size=\"11\">Nostro to Nairobi &#183; vostro to New York</text><line x1=\"245\" y1=\"128\" x2=\"260\" y2=\"138\" stroke=\"var(--brand)\" stroke-width=\"1.2\"/><text x=\"205\" y=\"42\" text-anchor=\"middle\" font-size=\"10.5\" class=\"t-mute\">screen &#183; fee &#183; cut-off</text><text x=\"455\" y=\"42\" text-anchor=\"middle\" font-size=\"10.5\" class=\"t-mute\">screen &#183; fee &#183; cut-off</text><text x=\"360\" y=\"225\" text-anchor=\"middle\" font-size=\"11.5\" class=\"t-mute\">Every hop repeats the checks. Three intermediaries means three of everything.</text></svg><figcaption>The money never crosses a border in one move. It walks along a chain of bilateral accounts, and <b>each hop screens, charges and applies its own cut-off</b> — which is the whole reason cross-border is slow, not the messaging.</figcaption></figure>\n<h4>Why it is slow and expensive</h4>\n<p>Not the messaging — a SWIFT message crosses the world in seconds. The delay is that each bank in the chain independently applies sanctions screening and financial crime checks, deducts a fee, and works to its own cut-off times and business days. Three intermediaries means three sets of checks, three fees, and three chances of a query stopping the payment.</p>\n<p>The chain also explains the two things corporates complain about most: they cannot see where a payment is, and they cannot tell the beneficiary exactly what will arrive.</p>\n<div class=\"callout warn\">Since the financial crisis, banks have exited correspondent relationships wholesale rather than carry the compliance cost — <strong>de-risking</strong>. The effect falls hardest on small banks in emerging markets, which is precisely where alternative rails have found their opening.</div>"
        },
        {
          "id": "m2l3",
    ...
    },
    {
      ...
      "lessons": [
        ...
        },
        {
          ...
          "body": "<p>Two mechanisms, routinely confused, with quite different consequences.</p>\n<h4>Physical pooling (cash concentration, sweeping)</h4>\n<p>Money genuinely moves. At end of day, balances sweep from participating accounts into a header account, often automatically and by rule — sweep everything, or sweep to leave a target balance. Consequences:</p>\n<ul>\n<li>Each sweep creates an <strong>intercompany loan</strong> between the entity and the header entity, which needs documentation and arm's-length interest</li>\n<li>Withholding tax can apply to that interest</li>\n<li>The group ends up with one external position instead of many, which is the point</li>\n</ul>\n<h4>Notional pooling</h4>\n<p>No money moves. The bank calculates interest as though the balances were one, so a subsidiary £2m overdrawn and another £3m in credit are charged and paid as if on £1m net. Attractive because it avoids intercompany lending entirely.</p>\n<p>The catch is on the bank's side. To offset for interest, the bank generally needs legal right of set-off across the participants, and cross-guarantees between them. Bank capital and leverage rules constrain when balances can be presented net rather than gross, and several banks pulled back from offering true cross-border notional pooling once those rules bit.</p>\n<h4>Cross-border</h4>\n<figure class=\"figure\"><svg viewBox=\"0 0 720 260\" role=\"img\" aria-label=\"Physical pooling moves money into a header account; notional pooling offsets balances without moving them\"><defs><marker id=\"ah\" viewBox=\"0 0 10 10\" refX=\"9\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\"><path d=\"M0,0 L10,5 L0,10 z\" fill=\"var(--ink3)\"/></marker></defs><text x=\"20\" y=\"24\" font-size=\"12.5\" class=\"t-strong\">Physical pooling</text><text x=\"20\" y=\"42\" font-size=\"11\" class=\"t-mute\">money moves</text><rect x=\"20\" y=\"58\" width=\"110\" height=\"38\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"75.0\" y=\"81.0\" text-anchor=\"middle\" font-size=\"13\" class=\"\">+3.0m</text><rect x=\"20\" y=\"104\" width=\"110\" height=\"38\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"75.0\" y=\"127.0\" text-anchor=\"middle\" font-size=\"13\" class=\"\">&#8722;2.0m</text><rect x=\"20\" y=\"150\" width=\"110\" height=\"38\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"75.0\" y=\"173.0\" text-anchor=\"middle\" font-size=\"13\" class=\"\">+1.0m</text><line x1=\"136\" y1=\"77\" x2=\"196\" y2=\"115\" stroke=\"var(--brand)\" stroke-width=\"2\" marker-end=\"url(#ah)\"/><line x1=\"136\" y1=\"123\" x2=\"196\" y2=\"123\" stroke=\"var(--brand)\" stroke-width=\"2\" marker-end=\"url(#ah)\"/><line x1=\"136\" y1=\"169\" x2=\"196\" y2=\"131\" stroke=\"var(--brand)\" stroke-width=\"2\" marker-end=\"url(#ah)\"/><rect x=\"200\" y=\"100\" width=\"130\" height=\"48\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"265.0\" y=\"120.0\" text-anchor=\"middle\" font-size=\"13\" class=\"t-strong\">Header</text><text x=\"265.0\" y=\"137.0\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">+2.0m</text><text x=\"175\" y=\"212\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">creates intercompany loans,</text><text x=\"175\" y=\"228\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">withholding tax, transfer pricing</text><line x1=\"360\" y1=\"10\" x2=\"360\" y2=\"245\" stroke=\"var(--line)\" stroke-width=\"1\"/><text x=\"392\" y=\"24\" font-size=\"12.5\" class=\"t-strong\">Notional pooling</text><text x=\"392\" y=\"42\" font-size=\"11\" class=\"t-mute\">nothing moves</text><rect x=\"392\" y=\"58\" width=\"110\" height=\"38\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"447.0\" y=\"81.0\" text-anchor=\"middle\" font-size=\"13\" class=\"\">+3.0m</text><rect x=\"392\" y=\"104\" width=\"110\" height=\"38\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"447.0\" y=\"127.0\" text-anchor=\"middle\" font-size=\"13\" class=\"\">&#8722;2.0m</text><rect x=\"392\" y=\"150\" width=\"110\" height=\"38\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"447.0\" y=\"173.0\" text-anchor=\"middle\" font-size=\"13\" class=\"\">+1.0m</text><path d=\"M512 66 q14 0 14 18 v16 q0 18 14 18 q-14 0 -14 18 v16 q0 18 -14 18\" fill=\"none\" stroke=\"var(--good)\" stroke-width=\"1.8\"/><rect x=\"556\" y=\"100\" width=\"140\" height=\"48\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--good)\" stroke-width=\"1.5\"/><text x=\"626.0\" y=\"120.0\" text-anchor=\"middle\" font-size=\"13\" class=\"t-strong\">Interest on</text><text x=\"626.0\" y=\"137.0\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">net +2.0m</text><text x=\"548\" y=\"212\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">needs right of set-off and cross-guarantees;</text><text x=\"548\" y=\"228\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">constrained by leverage and capital rules</text></svg><figcaption>Both give the group one net position. The difference is whether cash actually moves — which decides whether you have created <b>intercompany loans</b> or a <b>set-off arrangement the bank has to be able to support on its balance sheet</b>.</figcaption></figure>\n<p>The hard constraints are external. Capital controls in many markets restrict moving cash out; some currencies cannot leave at all. Withholding tax and transfer pricing shape what is worth doing. A treasurer with cash in a restricted market is not short of technology.</p>"
        },
        {
          "id": "m3l3",
          ...
          "body": "<p>Two ideas a treasurer thinks about constantly.</p>\n<h4>Trapped cash</h4>\n<p>Cash that legally exists but cannot be moved to where it is wanted — blocked by capital controls, by a tax charge on repatriation, by a regulatory minimum, or by a joint venture partner's consent rights. Groups routinely borrow at the centre while holding idle balances in restricted markets, because the alternative is worse.</p>\n<h4>The cash conversion cycle</h4>\n<p>How long a company's cash is tied up in operations:</p>\n<p><strong>CCC = DSO + DIO − DPO</strong></p>\n<ul>\n<li><strong>DSO</strong> — days sales outstanding: how long customers take to pay</li>\n<li><strong>DIO</strong> — days inventory outstanding: how long stock sits</li>\n<li><strong>DPO</strong> — days payable outstanding: how long the company takes to pay suppliers</li>\n</ul>\n<p>A shorter cycle means less cash locked in the business. Every transaction banking product aims at one of these terms: collections and receivables finance at DSO, payables finance at DPO, inventory and trade finance at DIO.</p>\n<figure class=\"figure\"><svg viewBox=\"0 0 720 240\" role=\"img\" aria-label=\"Timeline showing how DIO, DSO and DPO combine into the cash conversion cycle\"><line x1=\"40\" y1=\"60\" x2=\"690\" y2=\"60\" stroke=\"var(--line2)\" stroke-width=\"2\"/><line x1=\"60\" y1=\"52\" x2=\"60\" y2=\"68\" stroke=\"var(--line2)\" stroke-width=\"2\"/><line x1=\"250\" y1=\"52\" x2=\"250\" y2=\"68\" stroke=\"var(--line2)\" stroke-width=\"2\"/><line x1=\"430\" y1=\"52\" x2=\"430\" y2=\"68\" stroke=\"var(--line2)\" stroke-width=\"2\"/><line x1=\"660\" y1=\"52\" x2=\"660\" y2=\"68\" stroke=\"var(--line2)\" stroke-width=\"2\"/><text x=\"60\" y=\"42\" text-anchor=\"middle\" font-size=\"11\" class=\"t-strong\">Buy stock</text><text x=\"250\" y=\"42\" text-anchor=\"middle\" font-size=\"11\" class=\"t-strong\">Pay supplier</text><text x=\"430\" y=\"42\" text-anchor=\"middle\" font-size=\"11\" class=\"t-strong\">Sell</text><text x=\"660\" y=\"42\" text-anchor=\"middle\" font-size=\"11\" class=\"t-strong\">Get paid</text><rect x=\"60\" y=\"86\" width=\"370\" height=\"26\" rx=\"6\" fill=\"var(--bg2)\" stroke=\"var(--line2)\"/><text x=\"245\" y=\"103\" text-anchor=\"middle\" font-size=\"11.5\">DIO &#183; stock sitting</text><rect x=\"430\" y=\"86\" width=\"230\" height=\"26\" rx=\"6\" fill=\"var(--bg2)\" stroke=\"var(--line2)\"/><text x=\"545\" y=\"103\" text-anchor=\"middle\" font-size=\"11.5\">DSO &#183; waiting to be paid</text><rect x=\"60\" y=\"124\" width=\"190\" height=\"26\" rx=\"6\" fill=\"var(--bg2)\" stroke=\"var(--good)\"/><text x=\"155\" y=\"141\" text-anchor=\"middle\" font-size=\"11.5\">DPO &#183; supplier credit</text><rect x=\"250\" y=\"168\" width=\"410\" height=\"30\" rx=\"6\" fill=\"color-mix(in srgb, var(--brand) 14%, transparent)\" stroke=\"var(--brand)\" stroke-width=\"1.5\"/><text x=\"455\" y=\"188\" text-anchor=\"middle\" font-size=\"12.5\" class=\"t-strong\">Cash conversion cycle &#8212; your money is out of the business</text><text x=\"40\" y=\"224\" font-size=\"11\" class=\"t-mute\">Supplier credit (DPO) is the only part working in your favour: it delays when your cash leaves.</text></svg><figcaption>Every transaction banking product aims at one of these three bars. <b>Receivables finance shortens DSO, payables finance stretches DPO, trade and inventory finance attack DIO</b> — which is what makes an apparently unrelated product set coherent.</figcaption></figure>\n<div class=\"callout\">This is the frame that makes the product set coherent. A treasurer is not buying a payment; they are buying days out of the cycle. Sell a service that removes five days of DSO and the interest rate on the balance is a rounding error by comparison.</div>"
        },
        {
          "id": "m3l4",
      ...
      "lessons": [
        {
          ...
          "body": "<p>An exporter in Vietnam and an importer in Nigeria have never met. The exporter will not ship without assurance of payment; the importer will not pay without assurance of shipment. Somebody has to go first, and neither will.</p>\n<h4>The four ways to settle</h4>\n<ul>\n<li><strong>Cash in advance</strong> — importer pays first. All risk on the importer.</li>\n<li><strong>Open account</strong> — exporter ships and invoices, payment follows in 30 to 90 days. All risk on the exporter.</li>\n<li><strong>Documentary collection</strong> — banks pass documents against payment or acceptance, but no bank guarantees anything.</li>\n<li><strong>Letter of credit</strong> — a bank undertakes to pay against compliant documents. Risk moves to the bank.</li>\n</ul>\n<h4>Open account dominates</h4>\n<figure class=\"figure\"><svg viewBox=\"0 0 720 170\" role=\"img\" aria-label=\"Settlement methods arranged from all risk on the exporter to all risk on the importer\"><defs><linearGradient id=\"rg\" x1=\"0\" x2=\"1\"><stop offset=\"0\" stop-color=\"var(--bad)\" stop-opacity=\"0.5\"/><stop offset=\"1\" stop-color=\"var(--good)\" stop-opacity=\"0.5\"/></linearGradient></defs><rect x=\"40\" y=\"60\" width=\"640\" height=\"14\" rx=\"7\" fill=\"url(#rg)\"/><circle cx=\"80\" cy=\"67\" r=\"7\" fill=\"var(--bg2)\" stroke=\"var(--ink2)\" stroke-width=\"2\"/><circle cx=\"270\" cy=\"67\" r=\"7\" fill=\"var(--bg2)\" stroke=\"var(--ink2)\" stroke-width=\"2\"/><circle cx=\"460\" cy=\"67\" r=\"7\" fill=\"var(--bg2)\" stroke=\"var(--ink2)\" stroke-width=\"2\"/><circle cx=\"640\" cy=\"67\" r=\"7\" fill=\"var(--bg2)\" stroke=\"var(--ink2)\" stroke-width=\"2\"/><text x=\"80\" y=\"46\" text-anchor=\"middle\" font-size=\"11.5\" class=\"t-strong\">Open account</text><text x=\"270\" y=\"46\" text-anchor=\"middle\" font-size=\"11.5\" class=\"t-strong\">Documentary collection</text><text x=\"460\" y=\"46\" text-anchor=\"middle\" font-size=\"11.5\" class=\"t-strong\">Letter of credit</text><text x=\"640\" y=\"46\" text-anchor=\"middle\" font-size=\"11.5\" class=\"t-strong\">Cash in advance</text><text x=\"80\" y=\"96\" text-anchor=\"middle\" font-size=\"10.5\" class=\"t-mute\">ship, then hope</text><text x=\"270\" y=\"96\" text-anchor=\"middle\" font-size=\"10.5\" class=\"t-mute\">banks pass documents</text><text x=\"460\" y=\"96\" text-anchor=\"middle\" font-size=\"10.5\" class=\"t-mute\">bank&#8217;s promise to pay</text><text x=\"640\" y=\"96\" text-anchor=\"middle\" font-size=\"10.5\" class=\"t-mute\">paid before shipping</text><text x=\"40\" y=\"132\" font-size=\"11.5\" class=\"t-strong\">All risk on the exporter</text><text x=\"680\" y=\"132\" text-anchor=\"end\" font-size=\"11.5\" class=\"t-strong\">All risk on the importer</text><text x=\"40\" y=\"154\" font-size=\"11\" class=\"t-mute\">Most world trade sits at the left-hand end &#8212; which is exactly what created the receivables finance market.</text></svg><figcaption>The instruments are not alternatives so much as points on a spectrum of <b>who is exposed while the other side performs</b>.</figcaption></figure>\n<p>The large majority of world trade by value now settles on open account. Established relationships do not need an instrument, and credit insurance covers what remains. Documentary trade has been shrinking for decades as a share of the total.</p>\n<p>What remains documentary clusters where you would expect: new counterparties, politically or economically volatile markets, regulated commodity flows, and jurisdictions where an LC is required to obtain foreign exchange or clear customs.</p>\n<div class=\"callout\">Open account shifting risk onto the exporter is precisely what created the modern receivables and supply chain finance market. The instrument did not disappear — the financing need moved.</div>"
        },
        {
          "id": "m4l2",
          ...
          "body": "<p>A letter of credit substitutes a bank's promise for the buyer's. That single substitution is the product.</p>\n<h4>The parties</h4>\n<ul>\n<li><strong>Applicant</strong> — the buyer, who asks its bank to issue</li>\n<li><strong>Issuing bank</strong> — takes on the obligation to pay</li>\n<li><strong>Beneficiary</strong> — the seller, entitled to be paid</li>\n<li><strong>Advising bank</strong> — in the seller's country, authenticates and passes on the credit</li>\n<li><strong>Confirming bank</strong> — optionally adds its own independent undertaking, which matters when the issuing bank or its country is the risk the seller is worried about</li>\n</ul>\n<h4>The autonomy principle</h4>\n<figure class=\"figure\"><svg viewBox=\"0 0 720 280\" role=\"img\" aria-label=\"The six steps of a letter of credit between buyer, seller and their banks\"><defs><marker id=\"ah\" viewBox=\"0 0 10 10\" refX=\"9\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\"><path d=\"M0,0 L10,5 L0,10 z\" fill=\"var(--ink3)\"/></marker></defs><rect x=\"30\" y=\"40\" width=\"180\" height=\"56\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"120.0\" y=\"64.0\" text-anchor=\"middle\" font-size=\"13\" class=\"t-strong\">Applicant</text><text x=\"120.0\" y=\"81.0\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">the buyer</text><rect x=\"510\" y=\"40\" width=\"180\" height=\"56\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"600.0\" y=\"64.0\" text-anchor=\"middle\" font-size=\"13\" class=\"t-strong\">Beneficiary</text><text x=\"600.0\" y=\"81.0\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">the seller</text><rect x=\"30\" y=\"180\" width=\"180\" height=\"56\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"120.0\" y=\"204.0\" text-anchor=\"middle\" font-size=\"13\" class=\"t-strong\">Issuing bank</text><text x=\"120.0\" y=\"221.0\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">buyer&#8217;s bank</text><rect x=\"510\" y=\"180\" width=\"180\" height=\"56\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"600.0\" y=\"204.0\" text-anchor=\"middle\" font-size=\"13\" class=\"t-strong\">Advising bank</text><text x=\"600.0\" y=\"221.0\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">seller&#8217;s bank</text><line x1=\"120\" y1=\"100\" x2=\"120\" y2=\"174\" stroke=\"var(--ink3)\" stroke-width=\"2\" marker-end=\"url(#ah)\"/><text x=\"130\" y=\"140\" font-size=\"11\">1 &#183; asks for a credit</text><line x1=\"216\" y1=\"208\" x2=\"504\" y2=\"208\" stroke=\"var(--ink3)\" stroke-width=\"2\" marker-end=\"url(#ah)\"/><text x=\"360\" y=\"200\" text-anchor=\"middle\" font-size=\"11\">2 &#183; issues the credit</text><line x1=\"600\" y1=\"174\" x2=\"600\" y2=\"102\" stroke=\"var(--ink3)\" stroke-width=\"2\" marker-end=\"url(#ah)\"/><text x=\"612\" y=\"140\" font-size=\"11\">3 &#183; advises the seller</text><line x1=\"504\" y1=\"68\" x2=\"216\" y2=\"68\" stroke=\"var(--good)\" stroke-width=\"2\" marker-end=\"url(#ah)\"/><text x=\"360\" y=\"60\" text-anchor=\"middle\" font-size=\"11\">4 &#183; ships the goods</text><line x1=\"596\" y1=\"102\" x2=\"580\" y2=\"174\" stroke=\"var(--brand)\" stroke-width=\"2\" stroke-dasharray=\"5 3\" marker-end=\"url(#ah)\"/><text x=\"500\" y=\"150\" font-size=\"11\" class=\"t-mute\">5 &#183; presents documents</text><line x1=\"504\" y1=\"228\" x2=\"216\" y2=\"228\" stroke=\"var(--brand)\" stroke-width=\"2\" marker-end=\"url(#ah)\"/><text x=\"360\" y=\"248\" text-anchor=\"middle\" font-size=\"11\">6 &#183; pays against compliant documents</text><text x=\"360\" y=\"272\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">The banks never see the goods. Step 6 turns entirely on step 5.</text></svg><figcaption>Note what the banks are looking at. The cargo crosses at step&nbsp;4 and no bank inspects it; payment at step&nbsp;6 turns on whether the <b>documents</b> comply. That gap between goods and paperwork is where discrepancies and fraud both live.</figcaption></figure>\n<p>The credit is a separate contract from the sale. A dispute about the goods does not by itself relieve the bank of its obligation to pay against compliant documents. Without this, the instrument would be worthless — a bank cannot be asked to adjudicate commercial disputes.</p>\n<h4>Documents, not goods</h4>\n<p>Nobody at the issuing bank inspects the cargo. The bank checks whether the documents presented — invoice, transport document, insurance certificate, certificate of origin — comply with the credit on their face, under the ICC's <strong>UCP 600</strong> rules.</p>\n<p>A mismatch is a <strong>discrepancy</strong>, and discrepancies are the normal failure mode: a date out by a day, a goods description that does not read identically, an insured amount below the required percentage. A very large share of first presentations are discrepant. Most are curable if there is time before expiry, which is why presentation deadlines matter more than they appear to.</p>\n<div class=\"callout warn\">Fraud is the recognised exception to autonomy: courts will restrain payment where fraud is clearly established. The bar is deliberately high, because a low one would destroy the instrument.</div>"
        },
        {
          "id": "m4l3",
      ...
      "lessons": [
        {
          ...
          "body": "<p>An institutional investor does not hold securities directly. Ownership is recorded through a chain.</p>\n<ul>\n<li><strong>Investor</strong> — a pension fund or asset manager</li>\n<li><strong>Global custodian</strong> — a single relationship covering many markets</li>\n<li><strong>Sub-custodian</strong> — a bank in each local market, appointed by the global custodian</li>\n<li><strong>CSD</strong> — the central securities depository where the definitive record sits</li>\n<li><strong>ICSD</strong> — Euroclear or Clearstream, for internationally traded instruments</li>\n</ul>\n<p>Nothing is in a vault. Each link is an entry in a register, and custody is the business of maintaining those entries accurately and reconciling them constantly.</p>\n<h4>Omnibus versus segregated</h4>\n<figure class=\"figure\"><svg viewBox=\"0 0 720 200\" role=\"img\" aria-label=\"The custody chain from investor through global custodian and sub-custodian to the central securities depository\"><defs><marker id=\"ah\" viewBox=\"0 0 10 10\" refX=\"9\" refY=\"5\" markerWidth=\"6\" markerHeight=\"6\" orient=\"auto-start-reverse\"><path d=\"M0,0 L10,5 L0,10 z\" fill=\"var(--ink3)\"/></marker></defs><rect x=\"20\" y=\"70\" width=\"150\" height=\"58\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"95.0\" y=\"95.0\" text-anchor=\"middle\" font-size=\"13\" class=\"t-strong\">Investor</text><text x=\"95.0\" y=\"112.0\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">pension fund</text><rect x=\"205\" y=\"70\" width=\"160\" height=\"58\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"285.0\" y=\"95.0\" text-anchor=\"middle\" font-size=\"13\" class=\"t-strong\">Global custodian</text><text x=\"285.0\" y=\"112.0\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">one relationship</text><rect x=\"400\" y=\"70\" width=\"150\" height=\"58\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"475.0\" y=\"95.0\" text-anchor=\"middle\" font-size=\"13\" class=\"t-strong\">Sub-custodian</text><text x=\"475.0\" y=\"112.0\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">local market</text><rect x=\"585\" y=\"70\" width=\"115\" height=\"58\" rx=\"8\" fill=\"var(--bg2)\" stroke=\"var(--line2)\" stroke-width=\"1.5\"/><text x=\"642.5\" y=\"95.0\" text-anchor=\"middle\" font-size=\"13\" class=\"t-strong\">CSD</text><text x=\"642.5\" y=\"112.0\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">the record</text><line x1=\"176\" y1=\"99\" x2=\"199\" y2=\"99\" stroke=\"var(--ink3)\" stroke-width=\"2\" marker-end=\"url(#ah)\"/><line x1=\"371\" y1=\"99\" x2=\"394\" y2=\"99\" stroke=\"var(--ink3)\" stroke-width=\"2\" marker-end=\"url(#ah)\"/><line x1=\"556\" y1=\"99\" x2=\"579\" y2=\"99\" stroke=\"var(--ink3)\" stroke-width=\"2\" marker-end=\"url(#ah)\"/><text x=\"360\" y=\"36\" text-anchor=\"middle\" font-size=\"12\" class=\"t-strong\">Nothing is in a vault &#8212; every link is a register entry</text><text x=\"360\" y=\"160\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">In an omnibus account the custodian&#8217;s own books are what identify your assets.</text><text x=\"360\" y=\"178\" text-anchor=\"middle\" font-size=\"11\" class=\"t-mute\">That is the thing standing between you and your securities if it fails.</text></svg><figcaption>Custody is record-keeping, not safekeeping. The commercial consequence: a bank with <b>local presence in markets global custodians cannot reach economically</b> sells sub-custody to them, monetising network rather than balance sheet.</figcaption></figure>\n<p>Assets of many clients may sit in one <strong>omnibus</strong> account at the sub-custodian, with the custodian's own books identifying who owns what — efficient, and it makes the custodian's records the thing standing between a client and its assets in an insolvency. A <strong>segregated</strong> account holds one client's assets in their own name: safer, more expensive, and demanded by clients who have thought about failure.</p>\n<h4>The commercial shape</h4>\n<p>A bank with strong local presence in markets global custodians cannot reach economically sells <strong>sub-custody</strong> to those custodians. This is the FI business again: monetising network and licences rather than balance sheet, and it is why footprint in less-covered markets is a real asset.</p>"
        },
        {
          "id": "m5l2",
